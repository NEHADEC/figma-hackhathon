...
export default function BestSellerProducts() {
  const images = [
    "/p-1.png", // Path for first image
    "/p-2.png", // Path for second image
    "/p-3.png", // Path for third image
    "/p-4.png", // Path for fourth image
    "/p-5.png", // Path for fifth image
    "/p-6.png", // Path for sixth image
    "/p-7.png", // Path for seventh image
    "/p-8.png", // Path for eighth image
  ];
