...
const CardGrid = () => {
  const cards = [
    { id: 1, img: "/d1.png", name: "Username", description: "Profession" },
    { id: 2, img: "/d2.png", name: "Username", description: "Profession" },
    { id: 3, img: "/d3.png", name: "Username", description: "Profession" },
    { id: 4, img: "/d4.png", name: "Username", description: "Profession" },
    { id: 5, img: "/d5.png", name: "Username", description: "Profession" },
    { id: 6, img: "/d6.png", name: "Username", description: "Profession" },
    { id: 7, img: "/d7.png", name: "Username", description: "Profession" },
    { id: 8, img: "/d8.png", name: "Username", description: "Profession" },
    { id: 9, img: "/d9.png", name: "Username", description: "Profession" },
  ];
